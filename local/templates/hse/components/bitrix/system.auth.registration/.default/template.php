...
<?// ******************** /User properties ***************************************************
    ...
    <section class="register-section">
        <div class="register-container">
            ...
            <form class="register-form" method="post" action="<?=$arResult["AUTH_URL"]?>" name="bform" enctype="multipart/form-data">
                <input type="text" name="USER_NAME" class="input-field" maxlength="50" placeholder="Введите имя" required>
                <input type="text" name="USER_LAST_NAME" maxlength="50" class="input-field" placeholder="Введите фамилию" required>
                <input type="email" name="USER_EMAIL" maxlength="255" value="<?=$arResult["USER_EMAIL"]?>" class="input-field" placeholder="Введите логин (почту)*" required>
